...
```powershell
dotnet build NativeAnimiq/host/HostCore/HostCore.csproj -v minimal
dotnet build NativeAnimiq/host/WpfHost/WpfHost.csproj -v minimal
cmake --build NativeAnimiq/build --config Debug
dotnet build NativeAnimiq/host/HostApps.sln -v minimal
```
