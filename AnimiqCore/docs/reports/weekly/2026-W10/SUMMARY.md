...
- Newly added: review `2026-03-06_avatar_differential_benchmark_harness.md` for VSeeFace-vs-Animiq strict parity benchmark harness, managed DLL fingerprint probe, and VRM/MIQ-only (`vsfavatar` excluded) `P0/P1/P2/PASS` classifier + taxonomy/dashboard outputs.
