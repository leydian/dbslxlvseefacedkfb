# MIQ Full Parity Contract Enforcement (2026-03-06)

## Summary

This update enforces a strict parity contract for MIQ material loading across Unity runtime and native loader paths.
...
- native MIQ loader contract alignment
...
- Promoted unresolved typed texture refs to hard failure path (`MIQ_MATERIAL_TYPED_TEXTURE_UNRESOLVED` as primary error).
...
- sample load now fails in payload stage with strict parity contract signal:
  - `PrimaryError: MIQ_MATERIAL_SHADER_FAMILY_NOT_ALLOWED`
