...
This report covers native runtime execution support for MIQ physics payloads in `nativecore` (secondary motion pass), including policy, correction, frame integration, and lifecycle handling.
