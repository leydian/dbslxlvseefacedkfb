...
- Added richer summary fields:
  - `PythonExe`
  - `PythonSource` (`cli|env:ANIMIQ_MEDIAPIPE_PYTHON|default|missing`)
  - `RequireExplicitPythonExe`
...
- Strict default run: FAIL (expected without explicit Python pin)
  ...
  - `python_executable: FAIL (missing explicit python executable; set ANIMIQ_MEDIAPIPE_PYTHON or pass -PythonExe)`
