...
- PASS: `dotnet build NativeAnimiq/host/HostCore/HostCore.csproj -c Debug`
- PASS: `dotnet build NativeAnimiq/host/WpfHost/WpfHost.csproj -c Debug`
- FAIL (known): `dotnet build NativeAnimiq/host/WinUiHost/WinUiHost.csproj -c Debug`
