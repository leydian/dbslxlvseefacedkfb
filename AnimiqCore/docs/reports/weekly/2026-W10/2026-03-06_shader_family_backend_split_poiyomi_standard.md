...
powershell -ExecutionPolicy Bypass -File NativeAnimiq/tools/miq_render_regression_gate.ps1 `
  -SampleDir . `
  -AvatarToolPath NativeAnimiq/build/Release/avatar_tool.exe `
  -SummaryPath NativeAnimiq/build/reports/miq_render_regression_gate_summary.txt `
  -JsonSummaryPath NativeAnimiq/build/reports/miq_render_regression_gate_summary.json `
...
- `miq_render_regression_gate`: PASS
  - gate overall: PASS
