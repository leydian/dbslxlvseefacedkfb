...
1. `dotnet build NativeAnimiq\host\WpfHost\WpfHost.csproj -c Release --no-restore`
- Result: PASS
- Warnings: `0`
- Errors: `0`

2. `dotnet build NativeAnimiq\host\WinUiHost\WinUiHost.csproj -c Release --no-restore /p:BuildProjectReferences=false`
