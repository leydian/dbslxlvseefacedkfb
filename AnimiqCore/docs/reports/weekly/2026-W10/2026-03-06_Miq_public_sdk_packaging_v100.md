# MIQ Public SDK Packaging v1.0.0 Report (2026-03-06)

## Scope

This report summarizes the external-distribution hardening slice for
`com.animiq.miq` with a focus on package readiness, public documentation,
...
- `MiqLoadOptions` and `MiqLoadDiagnostics` surfaced as property-based contracts
...
- `tools/miq_package_release_gate.ps1`
...
```powershell
powershell -ExecutionPolicy Bypass -File .\tools\miq_package_release_gate.ps1
```

Observed:

- `PASS package=com.animiq.miq version=1.0.0`
