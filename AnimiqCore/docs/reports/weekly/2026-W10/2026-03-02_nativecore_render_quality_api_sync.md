...
This closes the gap where runtime behavior existed internally, but the ABI contract in `include/animiq/nativecore/api.h` did not expose it.

## Implemented Changes

1. Added public render quality types to C API header
- File: `include/animiq/nativecore/api.h`
- Added:
  - `NcCameraMode`
