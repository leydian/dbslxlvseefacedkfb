...
- Runtime/core and loader path hardening:
  - `src/avatar/vrm_loader.cpp`, `src/avatar/miq_loader.cpp`, `src/nativecore/native_core.cpp`
  - `include/animiq/nativecore/api.h`, `include/animiq/avatar/avatar_package.h`
  - `src/stream/spout_sender.cpp`, `include/animiq/stream/spout_sender.h`
...
- Gate/release/documentation/tooling track updates:
  ...
  - `docs/reports/miq_import_v4_rig_hardening_2026-03-06.md`
  - `docs/reports/miq_import_rig_accuracy_hardening_followup_2026-03-06.md`
...
- Build checks:
  ...
  - `dotnet build NativeAnimiq\host\WpfHost\WpfHost.csproj -c Release`: PASS (existing nullable warning retained)
...
- Generated local artifacts and large sample payloads outside `NativeAnimiq/` were intentionally excluded from documentation scope and commit intent.
...
dotnet build NativeAnimiq\host\HostCore\HostCore.csproj -c Release
dotnet build NativeAnimiq\host\WpfHost\WpfHost.csproj -c Release
dotnet build NativeAnimiq\host\WinUiHost\WinUiHost.csproj -c Release
