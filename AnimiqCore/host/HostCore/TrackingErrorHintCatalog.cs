...
public static class TrackingErrorHintCatalog
{
    public static string BuildHint(string? lastErrorCode)
    {
        ...
        return lastErrorCode switch
        {
            ...
            "TRACKING_MEDIAPIPE_CONFIG_INVALID" => " hint=webcam runtime config invalid (missing mediapipe_webcam_sidecar.py; set ANIMIQ_MEDIAPIPE_SIDECAR_SCRIPT)",
            "TRACKING_MEDIAPIPE_START_FAILED" => " hint=webcam sidecar start failed; verify ANIMIQ_MEDIAPIPE_PYTHON or run setup_tracking_python_venv.ps1",
