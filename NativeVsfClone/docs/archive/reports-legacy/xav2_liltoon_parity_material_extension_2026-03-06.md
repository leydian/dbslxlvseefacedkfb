# XAV2 lilToon parity material extension (2026-03-06)

## Summary

This update expands the practical lilToon parity path for `.xav2` by extending typed material extraction/import and native runtime shading coverage for high-impact visual controls.
