# XAV2 typed-v2 material params (lilToon phase1) implementation report (2026-03-06)

## Summary

This update introduces a structured material parameter path for XAV2 v2 (`0x0015`) and wires it across:
...
- schema parse failure: `XAV2_MATERIAL_TYPED_SCHEMA_INVALID`
- unsupported shader family warning: `XAV2_MATERIAL_TYPED_UNSUPPORTED_SHADER_FAMILY`
- liltoon required param warning (`_BaseColor`): `XAV2_MATERIAL_TYPED_MISSING_REQUIRED_PARAM`
