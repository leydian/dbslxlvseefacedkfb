# VRM to XAV2 Strict Allowlist and Quality Gate Upgrade (2026-03-06)

## Scope

This report covers the second hardening pass on `tools/vrm_to_xav2.cpp`, focused on strict policy control, diagnostics depth, and dedicated quality-gate automation.
...
- New `vrm_to_xav2`-specific quality gate script
...
- `tools/vrm_to_xav2_quality_gate.ps1`
...
- `build/reports/vrm_to_xav2_quality_gate_summary.json`
- `build/reports/vrm_to_xav2_quality_gate_summary.txt`
...
- Conversion with new options:
  - `vrm_to_xav2 --diag-json ... --perf-metrics-json ... <sample.vrm> <out.xav2>`
  - Result: PASS
- Strict allowlist smoke:
  - `vrm_to_xav2 --strict --strict-allowlist <allowlist> ...`
  - Result: PASS
- Quality gate run:
  - `tools/vrm_to_xav2_quality_gate.ps1`
