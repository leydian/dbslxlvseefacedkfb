...
- `powershell -ExecutionPolicy Bypass -File .\NativeVsfClone\tools\vrm_quality_gate.ps1 -SampleDir .\sample -AvatarToolPath .\NativeVsfClone\build\Release\avatar_tool.exe -Profile fixed5` : PASS
