# XAV2 Poiyomi typed material parity extension (2026-03-06)
...
- extractor Poiyomi typed emission expanded in `Xav2AvatarExtractors.cs`
- runtime loader test added in `Xav2RuntimeLoaderTests.cs`
