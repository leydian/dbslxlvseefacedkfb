...
```powershell
dotnet build D:\dbslxlvseefacedkfb\NativeVsfClone\host\HostCore\HostCore.csproj -c Release --no-restore
dotnet build D:\dbslxlvseefacedkfb\NativeVsfClone\host\WpfHost\WpfHost.csproj -c Release --no-restore
```
