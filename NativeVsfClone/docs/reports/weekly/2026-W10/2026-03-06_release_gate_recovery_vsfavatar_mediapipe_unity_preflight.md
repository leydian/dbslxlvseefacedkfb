...
- Unity XAV2 lane preflight execution and blocker capture
...
- Unity package metadata additions:
  - `unity/Packages/com.vsfclone.xav2/LICENSE.meta`
  - `unity/Packages/com.vsfclone.xav2/NOTICE.meta`
  - `unity/Packages/com.vsfclone.xav2/ThirdPartyNotices.md.meta`
...
powershell -ExecutionPolicy Bypass -File .\tools\release_gate_dashboard.ps1 -ReportDir D:\dbslxlvseefacedkfb\NativeVsfClone\build\reports -OutputJson D:\dbslxlvseefacedkfb\NativeVsfClone\build\reports\release_gate_dashboard.json -OutputTxt D:\dbslxlvseefacedkfb\NativeVsfClone\build\reports\release_gate_dashboard.txt
```
...
1. `ReleaseCandidateFull` remains FAIL because:
   ...
   - Unity XAV2 official LTS all-pass policy is not satisfiable with current environment (`2022-lts`/`2023-lts` editor paths missing).
...
2. Re-run Unity XAV2 validate/compression/parity lanes and LTS aggregate gate.
