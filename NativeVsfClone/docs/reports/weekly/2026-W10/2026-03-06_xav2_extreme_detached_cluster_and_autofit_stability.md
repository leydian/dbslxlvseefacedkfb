# XAV2 extreme detached-cluster draw guard + AutoFit bust stabilization (2026-03-06)

## Scope

- This report covers runtime-side XAV2 rendering/framing stabilization for:
...
- Bust framing stabilization:
  - XAV2 `AutoFitBust` blend updated:
...
- Draw-phase safety override in default `autofit_only` mode:
  ...
  - added unconditional extreme-detached skip for XAV2 small clusters:
...
- Contract/docs update:
  - `docs/formats/xav2.md`
    ...
    - added `XAV2_EXTREME_DETACHED_CLUSTER_SKIPPED` to related warning codes
...
1. Run `tools/xav2_render_regression_gate.ps1` against broader XAV2 sample set and compare warning deltas.
