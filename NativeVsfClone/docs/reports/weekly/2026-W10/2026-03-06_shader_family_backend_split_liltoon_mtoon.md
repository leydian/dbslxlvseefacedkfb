...
- If backend request cannot be honored (or conservative XAV2 path forces simplification), material falls back to `common`.
- Added warning codes:
...
- output: `NativeVsfClone/build/Release/nativecore.dll`
