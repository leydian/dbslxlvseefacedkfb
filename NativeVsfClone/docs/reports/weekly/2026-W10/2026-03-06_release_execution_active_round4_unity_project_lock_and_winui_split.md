...
2. Unity/XAV2 gate recovery attempt using discovered local Unity `2021.3.18f1` editor and matching project
...
### 2) Unity/XAV2 gate recovery attempt
...
- `tools/unity_xav2_validate.ps1` with explicit editor/project paths
- `tools/xav2_compression_quality_gate.ps1` with explicit editor/project paths
- `tools/xav2_parity_gate.ps1` with explicit editor/project paths
...
- `build/reports/unity_xav2_2021-lts_editmode.log`
- `build/reports/unity_xav2_2021-lts_compression_gate.log`
- `build/reports/unity_xav2_2021-lts_parity_gate.log`
...
2. Unity/XAV2 execution lane currently blocked by Unity project lock (project open elsewhere).
