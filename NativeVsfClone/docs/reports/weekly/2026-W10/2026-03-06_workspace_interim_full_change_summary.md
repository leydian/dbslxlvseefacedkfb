...
- `Xav2ExportMenu` now centralizes default export options through `CreateDefaultExportOptions(...)`.
...
- Documentation gate execution:
  - `powershell -ExecutionPolicy Bypass -File .\NativeVsfClone\tools\docs_quality_gate.ps1`
