...
### 3) Unity/XAV2 and KPI blocker path refresh
...
- local mirror source (`vsfclone-local-mirror`) is present and enabled.
...
- `ReleaseCandidateFull` remains blocked by:
  ...
  2. Unity editor-path prerequisite missing for XAV2 gates
  3. onboarding KPI session count below policy minimum (`5`)

## Next Steps

1. Set `UNITY_2021_3_18F1_EDITOR_PATH` in the execution lane and rerun all Unity/XAV2 gates.
