# ARKit52 Strict Full-Support Pipeline (VRM + XAV2) (2026-03-06)
...
2. Native avatar load path now builds ARKit52 expression bindings from blendshape payloads for both VRM and XAV2 paths.
