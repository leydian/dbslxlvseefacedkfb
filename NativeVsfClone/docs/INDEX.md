...
- [tracking_render_followup_2026-03-06.md](/D:/dbslxlvseefacedkfb/NativeVsfClone/docs/reports/tracking_render_followup_2026-03-06.md): hybrid tracking precision follow-up (iFacial primary + webcam fallback), WPF render drag/wheel controls, VRM node-transform application, and native depth-state correction
- [wpf_render_drag_capture_stabilization_2026-03-06.md](/D:/dbslxlvseefacedkfb/NativeVsfClone/docs/reports/wpf_render_drag_capture_stabilization_2026-03-06.md): WPF render child-HWND mouse capture/release hardening for stable right-drag camera interaction continuity
- [webcam_mediapipe_runtime_integration_2026-03-06.md](/D:/dbslxlvseefacedkfb/NativeVsfClone/docs/reports/webcam_mediapipe_runtime_integration_2026-03-06.md): MediaPipe sidecar-based webcam tracking runtime integration, packet contract mapping, diagnostics, and baseline gate wiring
