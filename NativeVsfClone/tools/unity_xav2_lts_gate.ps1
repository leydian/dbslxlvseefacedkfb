...
$historyCsvPath = Join-Path $ReportDir "unity_xav2_lts_gate_history.csv"
$kpiJsonPath = Join-Path $ReportDir "unity_xav2_lts_kpi_summary.json"
$kpiTxtPath = Join-Path $ReportDir "unity_xav2_lts_kpi_summary.txt"
...
$kpiLines.Add("Unity XAV2 LTS KPI Summary")
